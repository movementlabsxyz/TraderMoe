...
const IS_TRADERMOE =
  window.location.hostname === 'tradermoe.xyz' || window.location.hostname === 'staging.animeswap.org'
                ...
                <AutoRow>
                  <LinkWrapper>
                    <ExternalLink
                      ...
                      href={`https://github.com/TraderMoe/interface/issues/new?assignees=&labels=bug&body=${encodedBody}&title=${encodeURIComponent(
