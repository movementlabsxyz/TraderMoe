...
const ExplorerLabel = ({ chainId }: { chainId: SupportedChainId }) => {
  switch (chainId) {
    case SupportedChainId.MOVEMENT_TESTNET:
      return <Trans>Movement Explorer</Trans>
    default:
...
const NETWORK_SELECTOR_CHAINS = [SupportedChainId.MOVEMENT_TESTNET]
    ...
    async (targetChain: SupportedChainId, skipClose?: boolean) => {
      try {
        ...
        if (isProductionEnv()) {
          ...
          if (targetChain === SupportedChainId.MOVEMENT_TESTNET) {
            window.open('https://staging.animeswap.org/#/swap?chain=movement_testnet')
            return
          } else {
