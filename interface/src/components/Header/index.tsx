...
export default function Header() {
  ...
  const { nativeCoin, stableCoin, moeCoin } = getChainInfoOrDefault(chainId)
  ...
  useEffect(() => {
    if (isAptosChain(chainId)) {
      ...
      ConnectionInstance.getPair(nativeCoin.address, moeCoin.address)
      if (account) {
  ...
  return (
    <HeaderFrame showBackground={scrollY > 45}>
      <Title href="/#/swap?chain=movement_testnet">
        <AnimeIcon>
          <img
            src={Logo}
            alt="MOE"
