...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'tradermoe.xyz', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'tradermoe.xyz', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'tradermoe.xyz', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'tradermoe.xyz', pathname: '/asset.gif' } }, false],
