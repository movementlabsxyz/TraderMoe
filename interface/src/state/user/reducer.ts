...
if (!isProductionEnv()) {
  initialState.coins = {
    [SupportedChainId.APTOS]: APTOS_CoinInfo,
    [SupportedChainId.MOVEMENT_TESTNET]: MOVEMENT_TESTNET_CoinInfo,
  }
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(updateVersion, (state) => {
      // init chainId
      if (
        ![SupportedChainId.APTOS].includes(state.chainId)
      ) {
      ...
      if (!isProductionEnv()) {
        state.coins = {
          ...
          [SupportedChainId.MOVEMENT_TESTNET]: {
            ...MOVEMENT_TESTNET_CoinInfo,
            ...state.coins[SupportedChainId.MOVEMENT_TESTNET],
            ...MOVEMENT_TESTNET_CoinInfo,
          },
        }
        state.tempCoins = {
      ...
      if (!isProductionEnv()) {
        state.pairs[SupportedChainId.MOVEMENT_TESTNET] = state.pairs[SupportedChainId.MOVEMENT_TESTNET] || {}
      }
