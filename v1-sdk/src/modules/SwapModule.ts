...
export class SwapModule implements IModule {
  ...
  /**
   * The function will return all pairs created in TraderMoe, with CoinX and CoinY full name
   * @returns all pairs
   */
  ...
  /**
   * The function will return all pairs created in TraderMoe, with coin full name and reserve meta
   * @returns 
   */
  ...
  async getLPCoinAPY(params: CoinPair, deltaVersion?: Decimal | string): Promise<LPCoinAPYReturn> {
    ...
    const task2 = this.getPricePerLPCoin(params)
