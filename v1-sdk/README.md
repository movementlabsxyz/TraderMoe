# TraderMoe v1 Protocol SDK

[![Lint and Test](https://github.com/TraderMoe/v1-sdk/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/TraderMoe/v1-sdk/actions/workflows/lint-and-test.yml/badge.svg)
[![npm version](https://img.shields.io/npm/v/@tradermoe/v1-sdk/latest.svg)](https://img.shields.io/npm/v/@tradermoe/v1-sdk/latest.svg)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/@tradermoe/v1-sdk/latest.svg)](https://img.shields.io/bundlephobia/minzip/@tradermoe/v1-sdk/latest.svg)
[![downloads](https://img.shields.io/npm/dm/@tradermoe/v1-sdk)](https://img.shields.io/npm/dm/@tradermoe/v1-sdk)

The typescript SDK for [TraderMoe](https://tradermoe.xyz) v1 protocol.
...
# Installation
    ...
    yarn add "@tradermoe/v1-sdk"

# Usage Example
### Init SDK
```typescript
import { SDK } from '@tradermoe/v1-sdk';
...
(async () => {
  ...
  const BTC = '0x5672606854002b598c229d348a1f117dc036a6bc9772b0ea8a9bf8bd2f2c9d64::TestCoinsV1::BTC'
